...
// {
//     DialogBrightnessContrast dialog(this->presetsBrightnessContrast, this->gegl_brightness, this->gegl_contrast, this->isUpdateBrightnessContrast, this);
...
// {
//     DialogStress dialog(this->presetsStress, this->gegl_stress_radius, this->gegl_stress_samples, this->gegl_stress_iterations, this->gegl_stress_enhance_shadows, this->isUpdateStress, this);
...
// {
//     DialogStretchContrast dialog(this->gegl_stretch_contrast_keep_colors, this->gegl_stretch_contrast_perceptual, this->isUpdateStretchContrast);
...
// void MainWindow::UpdatePresetContrastCurve(const std::vector<PresetContrastCurve>& presets, const int index)
// {
